# 📚 คู่มือการใช้งาน MongoD

## ❓คำอธิบายสำหรับคำสั่งต่าง ๆ ใน MongoDB
...
### 2. เพิ่ม Document
- **เพิ่ม Document (insert)**: ใช้ `insertOne()` เพื่อเพิ่มเอกสารเดียว และ `insertMany()` เพื่อเพิ่มหลายเอกสารในคอลเลกชัน
...
### 4. สอบถามข้อมูล
- **find, findOne**: ใช้ `find()` เพื่อค้นหาทุกเอกสารในคอลเลกชัน และ `findOne()` เพื่อค้นหาเอกสารแรกที่ตรงกับเงื่อนไข
